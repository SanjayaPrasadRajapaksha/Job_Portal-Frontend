...
export default function MediaAdvertisingCommunications() {
    ...
    const fetchJobs = async () => {
      try {
        const res = await fetch(
          "http://localhost:5000/jobpost/category/Media, Advertising & Communications"
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {filteredJobs.length === 0 ? (
          <div className="col-span-full text-center text-gray-600">
            No jobs found for Media, Advertising & Communications.
          </div>
        ) : (

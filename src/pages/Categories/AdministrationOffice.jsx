...
import CommonFilterSearch from "../../components/CommonFilterSearch";
...
export default function JobOverviewTable() {
  ...
  return (
    <div className="p-4">
      <div className="flex items-center justify-between mb-3 gap-4">
        {/* Left: Category label */}
        <div className="text-[#720026] font-bold text-lg bg-[#f7b801]/20 px-4 py-2 rounded-lg shadow-sm border border-[#f7b801]">
          Administration & Office
        </div>
        {/* Right: Common filter/search */}
          ...
          <tbody>
            {filteredJobs.map((job, i) => (
              ...
              >
                ...
                <td className="py-3 px-3">{job.position}</td>
                <td className="py-3 px-3">{job.company}</td>
                <td className="py-3 px-3">{job.location}</td>
                <td className="py-3 px-3">{`Posted on ${job.postedOn}`}</td>

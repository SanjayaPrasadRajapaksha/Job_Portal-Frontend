    ...
    <>
      ...
      >
        <div className="flex-1 flex flex-col bg-gradient-to-b from-green-500 to-green-300 overflow-hidden">
          ...
          {isOpen && (
            <button
              className="block lg:hidden absolute top-1 right-3 w-9 h-9 flex items-center justify-center rounded-full text-yellow-500 hover:text-r7d-600 transition-colors"
